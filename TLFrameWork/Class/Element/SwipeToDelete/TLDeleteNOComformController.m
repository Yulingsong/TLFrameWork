...
@interface TLDeleteNOComformController()<UITableViewDelegate,UITableViewDataSource>
/** tablevieew */
...
@implementation TLDeleteNOComformController
...
-(void)viewDidLoad
{
    ...
    UILabel *lb = [UILabel labelWithFrame:TLRect(15/375, 29/667, 345/375, 60/667) BackgroundColor:TLClearColor text:@"Swipe to delete without confirm" textColor:[UIColor lightGrayColor] textAlignment:NSTextAlignmentLeft font:TLFont(15/375)];
