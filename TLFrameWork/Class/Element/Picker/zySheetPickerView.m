...
//    NSAttributedString *attrString = [[NSAttributedString alloc] initWithString:@"Cancel" attributes:
...
//    
    ...
    NSAttributedString *attrString2 = [[NSAttributedString alloc] initWithString:@"Done" attributes:
                                       @{ NSForegroundColorAttributeName: [UIColor grayColor],
                                          NSFontAttributeName :           [UIFont systemFontOfSize:14],
                                          NSUnderlineStyleAttributeName : @(NSUnderlineStyleNone) }];
    ...
    //选择器
    UIPickerView *pickerView = [[UIPickerView alloc] initWithFrame:CGRectMake(0,22, SCREEN_SIZE.width, 230)];
